...
interface IERC20 {
    ...
    //Returns a boolean value as a result of the operation
    function transferLottery(address client, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20 {
    ...
    string public constant name = "ERC20 Disney Token";
    ...
    function transferLottery(address client, address recipient, uint256 numTokens) public override returns (bool) {
