...
interface IERC20 {
    ...
    //Returns a boolean value as a result of the operation
    function transferDisney(address client, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20 {
    ...
    function transferDisney(address client, address recipient, uint256 numTokens) public override returns (bool) {
